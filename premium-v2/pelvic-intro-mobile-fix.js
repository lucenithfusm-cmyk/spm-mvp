...
function patch(){
  ...
  if(audio&&!audio.dataset.newIntro){audio.dataset.newIntro='1';audio.onclick=speak}
  if(replay&&!replay.dataset.newIntro){replay.dataset.newIntro='1';replay.onclick=speak}
