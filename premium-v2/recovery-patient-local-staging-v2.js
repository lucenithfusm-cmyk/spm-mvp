(()=>{
'use strict';
if(window.SPM_RECOVERY_PATIENT_LOCAL_V2)return;
window.SPM_RECOVERY_PATIENT_LOCAL_V2=true;
window.SPM_RECOVERY_PATIENT_HEYGEN_STAGING_V1=true;
...
style.textContent='.spm-v4-card.patient .spm-v4-visual>img{display:none!important}.spm-v4-visual video.spm-patient-master{width:100%;height:100%;object-fit:cover;display:block;background:#0b2026}';
