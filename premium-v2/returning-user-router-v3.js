...
async function saveCoach(){
 ...
 if(error){status(error.message,'danger');return}CTX.checkins.push(data);if($('coachDecision'))$('coachDecision').innerHTML=`<div class="notice ${d.code==='professional_review'?'danger':'good'}"><b>Daily Coach sugiere:</b> ${d.text}</div>`;renderProgress();status('Check-in guardado. Tu progreso ya está persistido.');
}
