...
## Español — approved text

Tu evaluación fue el primer paso. Ahora, empieza a trabajar en el cambio que buscas.
...
Actívalo por treinta y nueve dólares y comienza hoy tu Día Uno.

## English

Your assessment was the first step. Now, start working toward the change you want.
...
Changes belong only to `feat/commercial-conversion-v3` and Vercel `spm-premium-staging`. Main and GitHub Pages are outside this change. Approved recovery, nutrition and movement modules retain their existing content.

## HeyGen credit usage — user instruction, 2026-09-24
...
La comprobación visual detectó una pausa al entrar en la sección de herramientas. La visibilidad se recalcula también con la posición real durante el desplazamiento, para no depender únicamente de la notificación del observador. La prueba cubre el avance aun sin esa notificación.
